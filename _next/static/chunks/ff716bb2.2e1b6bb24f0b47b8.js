"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[938],{89201:function(e,t,n){n.d(t,{Tt:function(){return $},Vm:function(){return l},kW:function(){return v}});var r=n(46040),i=n(73821),o=n(70445);let{getBroadcastDims:a}=r.backend_util;function l(e,t,n){let l,C;let T=[];if(e.forEach(e=>{let t=r.D5U.sizeFromShape(e.shapeInfo.logicalShape);if(e.shapeInfo.isUniform?T.push(`uniform float ${e.name}${t>1?`[${t}]`:""};`):(T.push(`uniform sampler2D ${e.name};`),T.push(`uniform int offset${e.name};`)),n.enableShapeUniforms){let{uniformShape:t}=$(n.packedInputs,e.shapeInfo.logicalShape,e.shapeInfo.texShape);switch(t.length){case 1:T.push(`uniform int ${e.name}Shape;`);break;case 2:T.push(`uniform ivec2 ${e.name}Shape;`);break;case 3:T.push(`uniform ivec3 ${e.name}Shape;`);break;case 4:T.push(`uniform ivec4 ${e.name}Shape;`)}T.push(`uniform ivec2 ${e.name}TexShape;`)}}),n.enableShapeUniforms){switch(t.logicalShape.length){case 1:T.push("uniform int outShape;");break;case 2:T.push("uniform ivec2 outShape;"),T.push("uniform int outShapeStrides;");break;case 3:T.push("uniform ivec3 outShape;"),T.push("uniform ivec2 outShapeStrides;");break;case 4:T.push("uniform ivec4 outShape;"),T.push("uniform ivec3 outShapeStrides;")}T.push("uniform ivec2 outTexShape;")}n.customUniforms&&n.customUniforms.forEach(e=>{T.push(`uniform ${e.type} ${e.name}${e.arrayIndex?`[${e.arrayIndex}]`:""};`)});let m=T.join("\n"),R=e.map(e=>(function(e,t,n=!1,o){let l="";n?l+=function e(t,n){switch(t.shapeInfo.logicalShape.length){case 0:return function(e){let t=e.name,n="get"+t.charAt(0).toUpperCase()+t.slice(1),r=(0,i.A)();return`
    vec4 ${n}() {
...
`;function h(){return`
  ...
  `}function v(e){if(e<=1)return"int";if(2===e)return"ivec2";if(3===e)return"ivec3";if(4===e)return"ivec4";if(5===e)return"ivec5";if(6===e)return"ivec6";throw Error(`GPU for rank ${e} is not yet supported`)}function $(e,t,n){let{newShape:i,keptDims:o}=r.D5U.squeezeShape(t),a=t.length,l=e&&3===a&&1===t[0],c=l?t.slice(1):i,u=!e&&a>1&&!r.D5U.arraysEqual(t,n)&&i.length<a||l,p=u?c:t;return{useSqueezeShape:u,uniformShape:p,keptDims:o}}function f(e,t){let n=JSON.parse(JSON.stringify(e));return n.shapeInfo.logicalShape=t,n}function S(e,t){return t.map(t=>e[t]).join(", ")}}}]);